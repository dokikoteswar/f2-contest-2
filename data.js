...
function sortbyPassing(){
    const result = studentData.filter(checkAdult);
...
function sortGender(){
    const result = studentData.filter(sSex);
...
// const myData =[{"id":1,"first_name":"Chadwick","last_name":"Ayre","email":"cayre0@cam.ac.uk","gender":"Male","img_src":"https://robohash.org/corporisquiaperiam.png?size=50x50&set=set1","class":11,"marks":18,"passing":false,"city":"Moorreesburg"},
